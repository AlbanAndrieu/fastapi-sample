"""Tests for direct, internal and Cloudflare service-health evidence."""
    ...
    assert rows == [
        {
            ...
            "direct_probe_source": None,
            "direct_probe_observed_at": None,
            "direct_probe_age_seconds": None,
            "direct_probe_refresh_error": None,
            "internal_probe_source": None,
            "internal_probe_observed_at": None,
            "internal_probe_age_seconds": None,
            "internal_probe_refresh_error": None,
        },
    ]
