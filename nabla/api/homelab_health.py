...
def _copy_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if isinstance(truenas, dict):
        truenas_copy = {
            **truenas,
            "public": dict(truenas["public"]) if isinstance(truenas.get("public"), dict) else truenas.get("public"),
            "internal": dict(truenas["internal"]) if isinstance(truenas.get("internal"), dict) else truenas.get("internal"),
        }
    return {
        **payload,
