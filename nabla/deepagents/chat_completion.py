...
from nabla.deepagents.llm_factory import litellm_openai_api_base, resolve_openai_api_key_and_model
from nabla.config_settings import get_settings

_api_key, _default_chat_model = resolve_openai_api_key_and_model()
...
response = openai.ChatCompletion.create(
    ...
    max_tokens=100,
    messages=[{"role": "user", "content": "Who is Alban Andrieu?"}],
)
print(response)
