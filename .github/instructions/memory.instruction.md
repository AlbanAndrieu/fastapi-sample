...
Respecter la syntaxe et les exemples recommandés dans le README officiel pour toutes les intégrations TrueNAS.
La présence du SDK est à considérer comme garantie (installée avec uv) sur ce projet tant que la règle n'est pas modifiée.
