...
def set_release_version(version: str) -> None:
    ...
    # Prepare every file first. If one invariant drifts, raise before touching
    # any release metadata in the checkout.
    rendered = {
...
def main() -> int:
    ...
    parser.add_argument("version", help="stable SemVer release version, for example 1.4.1")
